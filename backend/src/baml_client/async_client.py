...
class BamlAsyncClient:
    ...
    async def ExtractInstigation(
      ...
      mdl = create_model("ExtractInstigationReturnType", inner=(types.MessageOutput, ...))
...
class BamlStreamClient:
    ...
    def ExtractInstigation(
        self,
        messages: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.MessageOutput, types.MessageOutput]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      mdl = create_model("ExtractInstigationReturnType", inner=(types.MessageOutput, ...))
      partial_mdl = create_model("ExtractInstigationPartialReturnType", inner=(partial_types.MessageOutput, ...))

      return baml_py.BamlStream[partial_types.MessageOutput, types.MessageOutput](
        raw,
